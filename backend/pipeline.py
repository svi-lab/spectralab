...
def stage_cosmic_ray_removal(da: xr.DataArray, crr_params: dict) -> xr.DataArray:
    crr = CosmicRayRemover(
        ...
        spike_width_units=crr_params.get("spike_width_units"),
        broad_width_units=crr_params.get("broad_width_units"),
        consensus_veto_fraction=crr_params.get("consensus_veto_fraction", 0.3),
